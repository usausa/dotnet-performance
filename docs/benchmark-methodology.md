...
| ⑦ | ref field cursor for structured reads | Does it beat the indexed form in the field-granular shape R-12 named? | STK-01 / R-12 | ✅ Adopted ([STK-11](../README.md), 0.81x on x86-64-v4 / 0.75x on v3, identical codegen) |
