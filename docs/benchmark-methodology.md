...
| R-04 foreach / for (array, Span) | Exactly equal | **Identical instruction sequence** (array 32 B / Span 54 B) | ❌ **No difference**. Pick for readability |
| R-04 for walking an array through a field | 2.20x | **Different code** (bounds check kept, reference reloaded, 67 B) | ✅ **Real difference**. Hoist the reference into a local |
