...
- AsSpan iteration 0.52x vs List foreach
- GetValueRefOrAddDefault read-modify-write 0.66x vs double lookup
- SetCount + span bulk build 0.22-0.26x vs Add loop, allocation halved
